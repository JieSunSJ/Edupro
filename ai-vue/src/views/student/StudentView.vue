  ...
  <div class="page-container">
    ...
    <el-card class="table-card">
      ...
      <el-table :data="tableData" border stripe v-loading="loading" style="width:100%">
        ...
        <el-table-column prop="no" label="学号" min-width="100" />
        <el-table-column prop="gender" label="性别" width="70" align="center">
          <template #default="{ row }">{{ row.gender === 1 ? '男' : '女' }}</template>
        </el-table-column>
        <el-table-column prop="phone" label="手机号" min-width="120" />
        <el-table-column prop="clazzName" label="班级" min-width="120" />
        <el-table-column prop="clazzMaster" label="班主任" min-width="80" />
...
const searchForm = reactive({ name: '', clazzId: null })
const tableData = ref([])
...
const handleAdd = () => {
  ...
  Object.assign(form, { id: null, name: '', no: '', gender: 1, phone: '', clazzId: null, address: '', violationCount: 0, violationScore: 0 })
