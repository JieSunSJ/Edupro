...
public class OperateLogAspect {
    ...
    @Around("execution(* cn.hytc.edupro.controller.*.add*(..)) || " +
            "execution(* cn.hytc.edupro.controller.*.update*(..)) || " +
            "execution(* cn.hytc.edupro.controller.*.delete*(..))")
    public Object around(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        try {
            ...
            if (args.length > 0) {
                ...
                if (firstArg instanceof cn.hytc.edupro.entity.Student) {
                    cn.hytc.edupro.entity.Student s = (cn.hytc.edupro.entity.Student) firstArg;
                    detail += ": " + s.getName();
                } else if (firstArg instanceof cn.hytc.edupro.entity.Clazz) {
                    cn.hytc.edupro.entity.Clazz c = (cn.hytc.edupro.entity.Clazz) firstArg;
                    detail += ": " + c.getName();
